...
# Plot the disknum vs. write time
...
for file in vm_files:
    if file.startswith('chunk_size_256_num_disk_8_') and 'jpeg' in file:
        ...
        vm_write_time_y.append(write_time)
vm_write_time_y = sorted(vm_write_time_y)
...
for file in local_files:
    if file.startswith('chunk_size_256_num_disk_8_') and 'jpeg' in file:
        ...
        local_write_time_y.append(write_time)
local_write_time_y = sorted(local_write_time_y)

species = ['500kb','1mb','2mb','5mb','10mb','15mb','20mb']
penguin_means = {
    'VM Disk': vm_write_time_y,
    'Local Disk': local_write_time_y
}
...
ax.set_ylabel('write Time (s)', fontsize=18)
...
plt.savefig('imgs/write_time_files.pdf')
# clear the figure
plt.clf()